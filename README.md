...
- Please report bugs through the issue tracker. The implementation was a one man project so mistakes are likely to show up.
...
- I tried my best at making a readme/manual on how to use SANEFALCON. I can imagine it is rather overwhelming. If you do not understand what to do anywhere, let me know so I can update this README.
